...
**The Sports Page** — a daily sports statistics newsletter at https://thesportspage.net/. Each issue takes one strange, extreme, or counterintuitive stat and explains what it actually means. Goal: 343 issues remaining of 500
...
Published: 157 issues (#1-157)
Queue: 15 articles ready (088-sorsby-supplemental-bet, 104-payroll-explosion-arms-race, 123-one-that-got-away, 124-how-many-stars, 137-schedule-leverage, 140-one-kick, 142-hope-curve, 143-dark-horse, 145-week1-signal, 146-sec-schedule-bias, 147-talent-addresses, 148-tommy-john-success, 149-where-players-die, 150-why-log-odds, _TEMPLATE)
...
Goal: 343 issues remaining of 500
Last published: Issue #157 — "We Built 252 Ways to Predict the Playoffs. The Best One Lost to the Simplest One." (139-overfit-grid.html) on September 1, 2026
