...
**The Sports Page** — a daily sports statistics newsletter at https://thesportspage.net/. Each issue takes one strange, extreme, or counterintuitive stat and explains what it actually means. Goal: 407 issues remaining of 500
...
Published: 93 issues (#1-93)
Queue: 11 articles ready (072-team-clustering, 073-analog-year-2021, 074-predictability, 075-prediction-frameworks, 076-mets-analog, 077-astros-analog, 078-cross-sport-persistence, 086-nd-dynasty-test, 088-sorsby-supplemental-bet, _TEMPLATE, bobby-bonilla-day)
New concept primer: concepts/necessary-vs-sufficient.html (Concept No. 13)
Reserve: 1 evergreen piece
Goal: 407 issues remaining of 500
Last published: Issue #93 — "A Career Doesn't Decline. It Disappears." (071-half-life-1-framework.html) on June 29, 2026
