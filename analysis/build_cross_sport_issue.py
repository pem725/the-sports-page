...
<main class="paper">
  ...
  <p class="deck">A reader asked the right next question: this newsletter's predictability work has so far been Major League Baseball against Steamboat Springs snowfall. What happens if you point the same test at football, hockey, basketball? The chart below is the answer. The four North American sports separate by more than a factor of two. The order is not random. It tracks how much of a roster carries over from one season to the next.</p>
  <p class="byline">The Sports Page &middot; Method: pooled lag-1 Pearson r of team win pct &middot; Data: 1985&ndash;2025 final standings, all four leagues, plus NOAA snowfall</p>
  ...
  <p>Four leagues, run head to head:</p>
...
{chart}
  ...
  <div class="pull">
    <p>The NBA's persistence is the league's superstar economics. The NFL's volatility is the league's draft and cap economics. The snow's noise is the atmosphere refusing to recognize anybody at all.</p>
  ...
  <div class="box" style="background:var(--ink)">
    ...
    <p style="color:#c8b99a">Snowfall: Steamboat Springs (NOAA GHCN-Daily USC00057936), 27 lag-1 season pairs since 1985. Colorado regional ski index: average of five NOAA stations (Aspen, Crested Butte, Steamboat, Telluride, Vail), 35 lag-1 pairs.</p>
